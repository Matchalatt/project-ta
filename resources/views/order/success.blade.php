...
<head>
    ...
    <title>Pembayaran Berhasil - Snack Juara</title>
...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <div class="bg-white p-8 rounded-lg shadow-md text-center max-w-md w-full">
        ...
        <p class="text-gray-600 mt-2">Terima kasih telah melakukan pemesanan di Snack Juara. Pesanan Anda sedang kami proses.</p>
